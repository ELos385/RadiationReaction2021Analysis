...
# blade_z = 25.07, gj_z = 27.14, therefore blade 2 mm in
...
plt.figure()
plt.errorbar(y_tip + offsets_final, z_shock, yerr=z_shock_err, marker='x', ls='', capsize=2, color='k')
plt.xlabel('Blade height over nozzle [mm]')
plt.ylabel('Shock position from south inner edge [mm]')
y_tip15, y_tip_o15, z_shock15, z_shock_err15 = y_tip, y_tip_o, z_shock, z_shock_err
