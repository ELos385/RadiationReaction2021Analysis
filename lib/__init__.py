...
register_data_loader('CsIStackTop', ImageDataLoader)
register_data_loader('CsIStackSide', ImageDataLoader)
register_data_loader('f2focus', GCamDataLoader)
register_data_loader('F40focus', GCamDataLoader)
register_data_loader('LA3timing', ImageDataLoader)
register_data_loader('LA3timing', ImageDataLoader)
register_data_loader('LMI', ImageDataLoader)
